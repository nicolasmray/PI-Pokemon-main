       ...
       <div className={style.container}>
            <div className={style.box} >
                ...
                <div className={style.filterTypeContainer}>
                    ...
                    <div className={style.filterTypeColumns}>
                        <select className={style.filterTypeColumn1} multiple={true} onChange={handleTypeChange} value={selectedTypes}>
                            {typesArray.map((type) => (
            ...
            <div className={style.filterOriginContainer}>
                ...
                <div className={style.filterOriginColumns}>
                    <select className={style.filterOriginColumn1} multiple={false} onChange={handleOriginChange} value={selectedOrigin}>
